...
public class BankAccountService {
    ...
    private final AccountInfoDataService accountInfoDataService = AccountInfoDataService
            .getInstance();
    ...
    public BankAccountInfo createAccount(String currency) {
        ...
        if (cur == null) {
            throw new UnsupportedOperationException(currency + " accounts not supported");
        }

        final BankAccountInfo.Builder newAccountBuilder = new BankAccountInfo.Builder()
        ...
        do {
            try {
                ...
                newAccount = newAccountBuilder.setAccountNumber(accountNumCounter.incrementAndGet())
                        .build();
            }
